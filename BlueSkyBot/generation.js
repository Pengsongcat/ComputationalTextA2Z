...
import { alienPronouns } from './pronGrammer.js';
...
export async function setup() {
  ...
  // Use RiTa's RiMarkov class in Node
  markov = new RiTa.RiMarkov(4);
...
// Node-friendly helpers to replace p5 functions
